...
export default function AIChatBox({ open, onClose }: AIChatBoxProps) {
    ...
    return (
        <div 
            className={cn(
                "bottom-0 right-0 z-50 w-full max-w-[500px] p-1 x1:right-36",
                open ? "fixed" : "hidden",
            )}
        >
            ...
            <div className="flex h-[600px] flex-col rounded border bg-background shadow-x1">
                    ...
                    {!error && messages.length === 0 && (
                        <div className="flex flex-col h-full items-center justify-center gap-3 text-center mx-8">
                            ...
                            <p>
                                ...
                                and it will find the relevant information on the website.
                            </p>
                            <p className="text-sm text-muted-foreground">
                                PS: If you want to leatn how to build your own AI chatbot, check 
                                out the tutorial on the {" "}
                                <a href="https://www.youtube.com/@codinginflow"
